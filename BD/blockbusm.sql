...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-12-2022 a las 02:46:05
...
('El Menú', 31, 'Misterio', 'Una joven pareja viaja a una exclusiva isla para degustar el menú de un chef mundialmente aclamado. Sin embargo, el chef ha introducido un ingrediente secreto que sorprenderá a los comensales.', 1, 2, 'R', 106, 'Ralph Fiennes, Anya Taylor-Joy, Nicholas Hoult, Hong Chau, Janet McTeer, Reed Birney, Judith Light, John Leguizamo', 0, 0, 78, 0, '../IMAGES/POSTERS/the-menu.jpg'),
...
('Iron Man', 30, 'Acción', 'Un empresario millonario construye un traje blindado y lo usa para combatir el crimen y el terrorismo.', 6, 10, 'PG', 126, 'Robert Downey Jr, Terrence Howard, Jeff Bridges, Shaun Toub, Paul Bettany, Gwyneth Paltrow', 0, 20, 91, 0, '../IMAGES/POSTERS/iron-man.jpg'),
...
('It', 42, 'Terror', 'Varios niños de una pequeña ciudad del estado de Maine se alían para combatir a una entidad diabólica que adopta la forma de un payaso y desde hace mucho tiempo emerge cada 27 años para saciarse de sangre infantil.', 4, 6, 'R', 135, 'Jaeden Martell, Bill Skarsgård, Finn Wolfhard, Jack Dylan Grazer, Wyatt Oleff, Jeremy Ray Taylor, Chosen Jacobs, Sophia Lillis', 0, 0, 84, 0, '../IMAGES/POSTERS/it.jpg'),
('It: Capítulo Dos', 34, 'Terror', 'En el misterioso pueblo de Derry, un payaso llamado Pennywise vuelve 27 años después para atormentar a los ahora adultos miembros del Club de los Perdedores, que se encuentran alejados unos de otros.', 2, 5, 'R', 169, 'Jessica Chastain, James McAvoy, Bill Hader, Isaiah Mustafa, Jay Ryan, James Ransone, Andy Bean, Bill Skarsgård', 0, 0, 78, 0, '../IMAGES/POSTERS/it2.jpg'),
...
('Percy Jackson y el ladrón del rayo', 28, 'Fantasía', 'Es la historia de dos jóvenes: uno problemático con tendencias violentas que inicia un romance con una niña rica.', 4, 4, 'PG', 120, 'Logan Lerman, Alexandra Daddario, Brandon T. Jackson, Jake Abel, Pierce Brosnan, Uma Thurman', 0, 0, 53, 0, '../IMAGES/POSTERS/pjo.jpg'),
('Percy Jackson y el mar de los monstruos', 23, 'Fantasía', 'Para encontrar el mágico Vellocino de Oro y salvar el campamento Half-Blood, Percy y sus amigos realizan una peligrosa odisea a un área conocida por los humanos como el Triángulo de las Bermudas.', 6, 6, 'PG', 107, 'Logan Lerman, Alexandra Daddario, Brandon T. Jackson, Douglas Smith, Jake Abel, Leven Rambin', 0, 0, 54, 0, '../IMAGES/POSTERS/pjo2.jpg'),
('Perfume: la historia de un asesino', 17, 'Suspenso', 'Un aprendiz de un perfumista en la Francia del siglo XVIII, obsesionado con capturar un elusivo aroma, la esencia de una joven mujer, se convierte en un asesino en serie que aterroriza a las familias del país.', 4, 4, 'R', 147, 'Ben Whishaw, Dustin Hoffman, Alan Rickman, Rachel, Hurd-Wood, Corinna Harfouch, Carlos Gramaje', 0, 0, 74, 0, '../IMAGES/POSTERS/perfume.jpg'),
...
(3, 'flo123@mail.com', 'Spy: una espía despistada'),
(4, 'flo123@mail.com', 'Fight Club');
...
CREATE TABLE `rentashistorial` (
  ...
  `pelicula` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `fecha` datetime(6) NOT NULL DEFAULT current_timestamp(6)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `rentashistorial`
--

INSERT INTO `rentashistorial` (`id`, `usuario`, `pelicula`, `fecha`) VALUES
(1, 'flo123@mail.com', 'Spy: una espía despistada', '2022-12-05 21:37:13.000000'),
(2, 'flo123@mail.com', 'Fight Club', '2022-12-05 21:38:01.000000');
